...
var Context_Context = /*#__PURE__*/function () {
  ...
  _createClass(Context, [{
    ...
    value: function _initialize() {
      ...
      this.options.container = this.options.container || this.layoutInfo.editor; // add.html optional buttons

      var buttons = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend({}, this.options.buttons);
      Object.keys(buttons).forEach(function (key) {
        _this.memo('button.' + key, buttons[key]);
      });
      var modules = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend({}, this.options.modules, external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.plugins || {}); // add.html and initialize modules
...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
  ...
  /**
   * Recover info about row and cell and add.html information to virtual table.
   *
...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    /**
     * table : [
     *  ['add.html', ['addRowDown', 'addRowUp', 'addColLeft', 'addColRight']],
