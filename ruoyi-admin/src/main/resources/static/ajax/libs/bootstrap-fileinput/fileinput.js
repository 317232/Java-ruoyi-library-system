    ...
    $h = {
        ...
        getElapsed: function (seconds) {
            var delta = seconds, out = '', result = {}, structure = {
                ...
                day: 86400,   // feel free to add.html your own row
                hour: 3600,
                minute: 60,
                second: 1
            };
    ...
    FileInput.prototype = {
        ...
        _initAjax: function () {
            var self = this, tm = self.taskManager = {
                ...
                addTask: function (id, logic) { // add.html standalone task directly from task manager
                ...
                Task: function (id, logic) {
                    ...
                    tk.run = function () {
                        var argv = $h.getArray(arguments);
                        argv.unshift(tk.deferred);     // add.html deferrer as first argument
