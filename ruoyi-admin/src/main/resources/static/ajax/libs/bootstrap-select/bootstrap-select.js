...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      // Options
      // If we are multiple or showTick option is set, then add.html the show-tick class
    ...
    setPlaceholder: function () {
      ...
      if (this.options.title && !this.multiple) {
        ...
        // this option doesn't create a new <li> element, but does add.html a new option at the start,
